...
public class ParamFlowRuleApolloPublisher implements DynamicRulePublisher<List<ParamFlowRuleEntity>> {
    ...
    @Override
    public void publish(String app, List<ParamFlowRuleEntity> rules, String resource) throws Exception {
        AssertUtil.notEmpty(app, "app name cannot be empty");
        if (rules == null) {
            return;
        }

        String flowDataId = ApolloConfigUtil.getParamFlowDataId(resource);
