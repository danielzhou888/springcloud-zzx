...
public class DegradeRuleApolloPublisher implements DynamicRulePublisher<List<DegradeRuleEntity>> {
    ...
    @Override
    public void publish(String app, List<DegradeRuleEntity> rules, String resource) throws Exception {
        AssertUtil.notEmpty(app, "app name cannot be empty");
        if (rules == null) {
            return;
        }

        String degradeDataId = ApolloConfigUtil.getDegradeDataId(resource);
