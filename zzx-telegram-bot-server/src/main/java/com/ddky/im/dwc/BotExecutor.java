...
import static com.ddky.im.dwc.LinkMessageConst.linkMessage;
import static com.ddky.im.dwc.LongMessageConst.longMessages;
import static com.ddky.im.dwc.NiceMessageConst.niceMessages;
import static com.ddky.im.dwc.WelcomeAdminMessageConst.WelcomeAdminMessages;
import static com.ddky.im.dwc.WelcomeCommonMessageConst.WelcomeCommonMessages;
...
//    private static int linkIntervals = 445000; // 发送链接消息的时间区间 (ms=毫秒)
    ...
    private static int intervals = 8000110; // 发送消息的区间（ms=毫秒）
    private static int stickerIntervals = 24000000; // 发送消息的区间（ms=毫秒）
    ...
    private static final String[] AdminBots = {
            "5036928537:AAHKNjTRhOUDHrqhq7qRkL92n0U8MzJ_ZwQ",
            "5079353378:AAGkmM2F3DoNUdxYLA3soOKF2OUWLzTvA1k"
    };
    private static final String[] CommonBots = {
                "5021307993:AAHS0NuHHYAH6cB9DL054crrXa6tSntb9ek",
...
//    }
    ...
    private static void sendAdminLinkMessage() {
        ...
        if (linkMessageList != null && linkMessageList.size() > 0) {
            for (int i = 0; i < botCount; i++) {
